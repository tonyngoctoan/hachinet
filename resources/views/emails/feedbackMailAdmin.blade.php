            ...
            <tr>
                <td valign="top" style="line-height: 24px; font-size: 16px; margin: 0;" align="left" bgcolor="#f7fafc">
                    <table class="container" role="presentation" border="0" cellpadding="0" cellspacing="0"
                        style="width: 100%; background: #ffb701;">
                        <tbody>
                            <tr>
                                <td align="center"
                                            ...
                                            <tr>
                                                <td style="line-height: 24px; font-size: 16px; margin: 0;" align="left">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; margin: 0;"
                                                                    align="left">
                                                                    <img class="w-16"
                                                                        src="https://hachinet.com/assets/img/logo-hachinet.png"
                                                    ...
                                                    <table class="card p-6 p-lg-10 space-y-4" role="presentation"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 30px;"
                                                                    align="left" bgcolor="#ffffff">
                                                                    <h4 class="h3 fw-700"
                                                                        style="padding-top: 0; padding-bottom: 0; font-weight: 600 !important; vertical-align: baseline; font-size: 16px; margin-bottom: 8px; margin-top: 0;"
                                                                        align="left">
                                                                        <span style="
                                                                        font-style: italic;
                                                                        font-weight: 500;">Customer:</span> {{ $data['name'] }},
                                                                    </h4>
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin-bottom: 8px; margin-top: 0;">
                                                                        <span style="font-weight: 500;">Message</span>: {{ $data['message'] }}
                                                                    </p>
                                                                    <p class=""
                                                                        style="line-height: 24px; font-size: 16px; width: 100%; margin-bottom: 8px; margin-top: 0;"
                                                                        align="left">
                                                                        <span style="font-weight: 500;">Email</span>: {{ $data['email'] }}.
                                                                    </p>
                                                                    <table class="s-4 w-full" role="presentation"
                                                                        border="0" cellpadding="0" cellspacing="0"
                                                                        style="width: 100%;margin-bottom: 4px; margin-top: 0;" width="100%">
                                                                        <tbody>
                                                                            <tr>
                                                                                <td style="line-height: 16px; font-size: 16px; width: 100%; height: 16px;"
                                                                                    align="left" width="100%"
                                                                                    height="16">Thanks and best regards,
                                                                                </td>
                                                                            </tr>
                                                                        </tbody>
                                                                    </table>
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td align="center" style="width: 100%;padding:10px;">
                                                                    ...
                                                                    line-height: 1.5em;
                                                                    font-size: 14px;
                                                                    text-align: center;">© {{ date('Y') }}<a
                                                                            href="{{ config('app.url') }}"
                                                                            target="_blank" style="color: #e2e8f0;"> {{
                                                                            config('app.name') }}</a>. All
                                                                        Rights Reserved.
                                                                    </p>
                                                                </td>
                                                            </tr>
