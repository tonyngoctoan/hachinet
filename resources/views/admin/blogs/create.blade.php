                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            {{-- <a class="btn btn-primary btn-round ml-auto" href="{{ route('admin.blogs.create') }}">
                        ...
                        <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="col-sm-12 p-0">
                                        ...
                                        <div
                                            ...
                                            <input id="addTitle" type="text" name="title" value="{{ old('title') }}"
                                    ...
                                    <div class="col-sm-12 p-0">
                                        <div
                                            ...
                                            <label>Mô tả</label>
                                            <textarea id="addDescription" value="" name="description" rows="5" class="form-control" placeholder="Mô tả">{{ old('description') }}</textarea>
                                        </div>
                                        @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    ...
                                    <div class="col-sm-12 p-0">
                                        <div
                                            ...
                                            <textarea id="addContent" name="content" value="" rows="16" class="form-control" placeholder="Nội dung">{{ old('content') }}</textarea>
                                        </div>
                                        @error('content')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="col-sm-12 p-0">
                                        <div
                                            ...
                                            <div class="d-inline-flex">
                                                ...
                                                <label class="form-radio-label col-md-6 d-flex align-content-center">
                                                    <input class="form-radio-input m-0 mr-2" type="radio" name="status"
                                                        value="inactive">
                                    ...
                                    <div class="col-sm-12 p-0">
                                        <div class="form-group form-group-default">
                                            <label>Tag</label>
                                            <input type="text" data-role="tagsinput" name="tag" class="form-control"
                                                placeholder="">
                                        </div>
                                    </div>
                                    <div class="col-sm-12 p-0">
                                        <div
                                            ...
                                            <input id="addThumbnail" type="file" name="thumbnail" class="form-control"
                                                placeholder="Ảnh bài viết">
                                            <img src="" id="preview-image" class="mt-2" width="120px"
                                                alt="">
                                        </div>
                                        @error('thumbnail')
                                            <p class="text-danger">{{ $message }}</p>
                                ...
                                <div class="col-md-8 modal-footer no-bd">
                                    ...
                                    <button type="reset" class="btn-close btn btn-danger">Hủy</button>
                                </div>
                            </div>
                        </form>
                    </div>
