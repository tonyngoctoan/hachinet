                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-sm-12">
                                                    <div class="form-group form-group-default email">
                                                        <label>Email</label>
                                                        <input id="addMail" type="text" name="email"
                                                            class="form-control" placeholder="Email">
                                                    </div>
                                                </div>
                                                <div class="col-sm-12">
                                                    <div class="form-group form-group-default password">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $(document).on("click", ".add-category", function(e) {
                    ...
                    $(".fw-mediumbold").text('Thêm tài khoản')
                ...
                $(document).on("click", ".edit-account", function() {
                    ...
                    $(".fw-mediumbold").text('Sửa tài khoản')
                    $.ajax({
                        type: "GET",
                        url: "{{ route('api.accounts.edit', '') }}/" + id,
                        dataType: "JSON",
                        success: function(response) {
                            $("#addName").val(response.name)
                            $("#addMail").val(response.email)
                            $("#addPassword").val(response.password)
                            $("#addPhone").val(response.phone)
                ...
                $(document).on('click', '#addRowButton', function() {
                    ...
                    var url = '{!! route('accounts.store') !!}';
                    if ($("input[name=id_cate]").val() != '') {
                        url = '{!! route('accounts.update', '') !!}/' + $("input[name=id_cate]").val()
                    ...
                    $.ajax({
                        ...
                        error: function(response) {
                            ...
                            if (response.responseJSON.errors) {
                                if (response.responseJSON.errors.avatar) {
                                    $(".avatar-file").addClass("border border-danger");
                                    content.message = response.responseJSON.errors.avatar[0];
                                }
                                if (response.responseJSON.errors.password) {
                                    $(".password").addClass("border border-danger");
                                    content.message = response.responseJSON.errors.password[0];
                                }
                                if (response.responseJSON.errors.email) {
                                    $(".email").addClass("border border-danger");
                                    content.message = response.responseJSON.errors.email[0];
                                }
                                ...
                                setTimeout(() => {
                                    ...
                                    $(".avatar-file").removeClass("border border-danger");
                                }, 4000);
                                $.notify(content, {
                                    type: 'danger',
                                    placement: {
                ...
                $(document).on('click', '.delete-account', function() {
                    swal({
                        ...
                        text: "Sau khi xóa tài khoản thì không thể khôi phục!",
                        type: 'warning',
                        buttons: {
                            confirm: {
                                text: 'Xóa',
