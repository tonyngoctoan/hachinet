                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex align-items-center">
                            ...
                            <a href="{{ route('admin.case-study.create') }}" class="btn-round ml-auto btn-hachinet">
                            ...
                            <table id="add-row" class="display table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 130px !important;">Ngày hoàn thiện</th>
                                        <th style="width: 90px !important;">Khách hàng</th>
                                        <th style="width: 120px !important;">Loại</th>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                var table = $('#add-row').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('api.case-study.list') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
